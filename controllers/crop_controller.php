...
function addCrop_ctr($crop_name,$farmer_name,$farm_size,$qty,$crop_price,$crop_image,$crop_cat,$crop_desc)
{
    // create an instance of the crop class
    $add_crop = new crop_class();

    return $add_crop->add_crop($crop_name,$farmer_name,$farm_size,$qty,$crop_price,$crop_image,$crop_cat,$crop_desc);
}
