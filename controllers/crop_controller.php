...
function updateCropdetails_ctr($crop_id,$crop_name,$farmer_name,$farmer_contact,$farm_size,$qty,$crop_price,$crop_cat,$crop_desc)
{
    // create an instance of the crop class
    $update_crop = new crop_class();

    return $update_crop->update_cropdetails($crop_id,$crop_name,$farmer_name,$farmer_contact,$farm_size,$qty,$crop_price,$crop_cat,$crop_desc);
}
